...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["auth-registro-registro-registro-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAuthRegistroRegistroRegistroPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAuthRegistroRegistroRegistroRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAuthRegistroRegistroRegistroModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAuthRegistroRegistroRegistroPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAuthRegistroRegistroRegistroPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_servicios_fcm_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! src/app/servicios/fcm.service */
    "./src/app/servicios/fcm.service.ts");
    /* harmony import */


    var src_app_servicios_perfil_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! src/app/servicios/perfil.service */
    "./src/app/servicios/perfil.service.ts");
    /* harmony import */


    var _aviso_correcto_correcto_page__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ../../../aviso/correcto/correcto.page */
    "./src/app/aviso/correcto/correcto.page.ts");
    /* harmony import */


    var _aviso_incorrecto_incorrecto_page__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ../../../aviso/incorrecto/incorrecto.page */
    "./src/app/aviso/incorrecto/incorrecto.page.ts");
    /* harmony import */


    var src_app_politicas_politicas_page__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! src/app/politicas/politicas.page */
    "./src/app/politicas/politicas.page.ts");

    var RegistroPage = /*#__PURE__*/function () {
      function RegistroPage(authService, router, loading, navCtrlr, modalCtrl, fcm, firebase, perfilService, storage, component) {
      ...
      _createClass(RegistroPage, [{
        ...
        key: "registroR",
        value: function registroR(formR) {
          var _this = this;

          this.authService.addUser(formR).subscribe(function (data) {
            console.log("imprimiendo data", data, formR);

            if (data.valid == "OK") {
              _this.mensajeCorrecto("Registro exitoso", "");
              ...
              _this.storage.set('correo', formR.email);
              ...
              _this.mensajeIncorrecto("Error", "La cédula ya se encuentra registrada");

              _this.router.navigateByUrl('/registro');
            } else if (data.valid == 'EMAIL') {
              _this.mensajeIncorrecto("Error", "El correo ya se encuentra registrado");

              _this.router.navigateByUrl('/registro');
            } else {
              _this.mensajeIncorrecto("Error", "Ha ocurrido un error, intentar de nuevo");
        ...
        value: function validarCedula(cedula) {
          ...
          if (cedula.length === 10) {
            ...
            if (Number(digitoRegion) >= 1 && Number(digitoRegion) <= 24) {
              var ultimoDigito = Number(cedula.substring(9, 10));
              var pares = Number(cedula.substring(1, 2)) + Number(cedula.substring(3, 4)) + Number(cedula.substring(5, 6)) + Number(cedula.substring(7, 8));
              ...
              var decena = (Number(primerDigitoSuma) + 1) * 10;
              console.log(decena);
        ...
        value: function onSelectFile(event) {
          ...
          if (event.target.files && event.target.files[0]) {
            ...
            reader.onload = function (event) {
              ...
              var buf = _this4.convert(event.target.result, ul);
        ...
        key: "uploadPersonaImage",
        value: function uploadPersonaImage(e) {
        ...
        key: "isEqual",
        value: function isEqual(str1, str2) {
    ...
    RegistroPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/auth/registro/registro/registro.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./registro.page.scss */
      "./src/app/auth/registro/registro/registro.page.scss"))["default"]]
    })], RegistroPage); //https://stackblitz.com/edit/angular-file-upload-preview-85v9bg

    /***/
  }
}]);
//# sourceMappingURL=auth-registro-registro-registro-module-es5.js.map
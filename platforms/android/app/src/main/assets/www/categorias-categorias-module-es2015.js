...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | detalle-categoria-detalle-categoria-module */ "detalle-categoria-detalle-categoria-module").then(__webpack_require__.bind(null, /*! ./detalle-categoria/detalle-categoria.module */ "./src/app/categorias/detalle-categoria/detalle-categoria.module.ts")).then(m => m.DetalleCategoriaPageModule)
    }
];
...
let CategoriasPage = class CategoriasPage {
    constructor(productoService, router, alert, loadingCtrl, storage, modalCtrl) {

...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["historial-historial-module"], {
  ...
  function srcAppHistorialHistorialRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        return Promise.all(
        /*! import() | detalle-historial-detalle-historial-module */
        [__webpack_require__.e("default~detalle-historial-detalle-historial-module~efectivo-efectivo-module~historial-detalle-histor~54d42855"), __webpack_require__.e("default~calificar-calificar-module~detalle-historial-detalle-historial-module~historial-detalle-hist~b3534f4a"), __webpack_require__.e("default~detalle-historial-detalle-historial-module~historial-detalle-historial-detalle-historial-module")]).then(__webpack_require__.bind(null,
        /*! ./detalle-historial/detalle-historial.module */
  ...
  function srcAppHistorialHistorialModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    HistorialPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _historial_routing_module__WEBPACK_IMPORTED_MODULE_5__["HistorialPageRoutingModule"], _components_components_module__WEBPACK_IMPORTED_MODULE_7__["ComponentsModule"]],
  ...
  function srcAppHistorialHistorialPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _servicios_historial_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../servicios/historial.service */
    "./src/app/servicios/historial.service.ts");

    var HistorialPage = /*#__PURE__*/function () {
      function HistorialPage(loadingCtrl, storage, router, modalController, historialService) {
        ...
        value: function ionViewDidEnter() {
          ...
          this.storage.get('id').then(function (val) {
            if (val != null) {
              ...
              _this.mensajeIncorrecto("Inicie sesión", "Debe iniciar sesión para revisar su historial de pedidos");
            }
          });
        }
      }, {
        key: "buscarHistorial",
        value: function buscarHistorial(id) {
            ...
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 2:
                    this.buscarHistorial(id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["finalize"])(function () {
                      ...
                      _this2.historiales = data;

                      if (Object.keys(_this2.historiales).length === 0) {
                        _this2.mensajeIncorrecto("Historial vacío", "No ha realizado pedidos");
                      }
                    }, function (err) {
